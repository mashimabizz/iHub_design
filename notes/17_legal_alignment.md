...
> **目的**：弁護士納品の規約原典（2024-07-18）と現状の iHub 設計（2026-05-01）の齟齬を整理し、規約改訂・実装修正の方針を定義。
> 弁護士への再依頼資料としても活用。

最終更新: 2026-05-01（iter46）
ステータス: Draft v1.0（弁護士レビュー待ち）
...
- [`iHub/legal-pages.jsx`](../iHub/legal-pages.jsx) — 現在の表示
